                        ...
                        <div className="row justify-content-center features">
                            <div className="col-sm-6 col-md-5 col-lg-4 item">
                                <div className="box">
                                    ...
                                    <a className="learn-more">Start »</a>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-5 col-lg-4 item">
                                <div className="box">
                                    <i className="fa fa-bolt icon"></i>
                                    <h3 className="name">Running Words</h3>
                                    <p className="description">The aim of this exercise is to see all the words on
                                        the screen, focusing on the center.</p>

                                    <Link className="learn-more" to="/running-words">Start »</Link>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-5 col-lg-4 item">
                                <div className="box">
                                    ...
                                    <p className="description">The exercise develops concentration, that allows you
                                        to absord a lot of information.</p>
                                    <a className="learn-more">Start »</a>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-5 col-lg-4 item">
